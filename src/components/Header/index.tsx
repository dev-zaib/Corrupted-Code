    ...
    <>
      <header className={props.className}>
        ...
        <div className="flex flex-row gap-10 items-center justify-center w-auto">
          ...
          <List
            className="sm:flex-col flex-row gap-10 grid grid-cols-2 w-[47%]"
            orientation="horizontal"
          >
            <div className="flex flex-col items-center justify-start w-auto">
              <div className="border border-gray-900_02 border-solid flex flex-row gap-0.5 items-center justify-start w-auto">
                <div className="flex flex-col items-center justify-start w-auto">
                  <Text
                    className="text-gray-900_02 text-sm w-auto"
                    size="txtSpaceGroteskMedium14"
